...
```
    ...
    ##     X          x          y genotype cell_type       group
    ## 1   1  1.1609159 -0.5255275       WT         C        WT.C
    ## 2   2 -1.2307550 -0.6073502       WT        NC       WT.NC
    ## 3   3  1.0384222 -0.7642217       WT         C        WT.C
    ## 4   4 -1.3776325 -0.8016371       WT        NC       WT.NC
    ## 5   5  0.9955139 -0.7239360       WT         C        WT.C
    ## 6   6 -1.3883508 -0.6610710       WT        NC       WT.NC
    ## 7   7  0.9425299 -0.6162212 KOMIR150         C  KOMIR150.C
    ## 8   8 -1.4484494 -0.6410344 KOMIR150        NC KOMIR150.NC
    ## 9   9  1.1356262 -0.5268719 KOMIR150         C  KOMIR150.C
    ## 10 10 -1.1798117 -0.5092037 KOMIR150        NC KOMIR150.NC
    ## 11 11  1.0550946 -0.3700157 KOMIR150         C  KOMIR150.C
    ## 12 12 -1.1676243 -0.4957853 KOMIR150        NC KOMIR150.NC
    ## 13 13  1.5090010  1.0448959   KOTet3         C    KOTet3.C
    ## 14 14 -1.4602144  1.1835866   KOTet3        NC   KOTet3.NC
    ## 15 15  1.7219177  0.7208150   KOTet3         C    KOTet3.C
    ## 16 16 -1.4753275  0.8143014   KOTet3        NC   KOTet3.NC
    ## 17 17  1.5912625  0.5490907   KOTet3         C    KOTet3.C
    ## 18 18 -1.0078659  0.7728502       WT        NC       WT.NC
    ## 19 19  1.4723792  0.5418471       WT         C        WT.C
    ## 20 20 -1.0024911  1.5556196       WT        NC       WT.NC
    ## 21 21  1.2842384 -0.1367418       WT         C        WT.C
    ## 22 22 -1.1683789  0.1966110       WT        NC       WT.NC

``` r
q <- ggplot(data = mds, mapping = aes(x = x,
                                      y = y,
                                      color = genotype,
                                      shape = cell_type)) +
  geom_point(size = 3) +
  ...
  coord_fixed() +
  theme_bw()
q + scale_shape_manual(values = c(15, 17))
```
...
Use point size in a scatter plot demonstrating the relationship between
weight, cyl, and mpg in the mtcars data set. Consider using other
aesthetics to add further information (e.g. gear, hp, or manufacturer).
...
``` r
download.file("https://raw.githubusercontent.com/ucdavis-bioinformatics-training/2025-August-Intermediate-Visualization-for-Bioinformatics/refs/heads/master/R/03-barplot.Rmd", "03-barplot.Rmd")
sessionInfo()
```
