...
```{r prepare_next}
download.file("https://raw.githubusercontent.com/ucdavis-bioinformatics-training/2025-August-Intermediate-Visualization-for-Bioinformatics/R/02-scatterplot.Rmd")
sessionInfo()
```
