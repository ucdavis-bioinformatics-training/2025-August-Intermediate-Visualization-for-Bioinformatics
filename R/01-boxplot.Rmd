...
We'll use gene expression data from a single cell experiment for these plots. Typically this sort of data is stored in a complex structure which retains expression data and experiment metadata together in a single object. In this case, the data provided has been extracted from the Seurat object used in the single cell workshop. Only a small number of markers are used to limit the size of the object.
...
Relevant metadata from the Seurat object has been added to the expression data to form a single data frame.
